...
def e_to_min_x2(x: float):
    # +-inf: 1.77245385090551602729816748
    # +-10:  1.77245385090551602729816748
    return np.exp(-(x * x))


def e_to_min_x2_x(x: float):
    # +-inf: 0
    # +-10: 0
    return np.exp(-(x * x)) * x


def e_to_min_x2_sin(x: float):
    # +-inf: 0
    # +-10: 0
    # 0, 10: 0.424436
